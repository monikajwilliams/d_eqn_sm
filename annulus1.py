...
def make_gifs(
    ...
    t3 = np.arange(10.0,200.0,10.0)
    t4 = np.arange(300,tmax+50.0,50.0)
    t_plots = np.hstack((t1,t2,t3,t4))
    ...
    if log == False:
        ...
        lvls = np.logspace(-3.5,np.log10(top)+0.1,500)
        interval = np.arange(0,len(lvls),50)  
        labels = []
...
make_gifs(tmax=400.0,k=8.0)
#make_gifs(tmax=500.0,k=0.0)
